...
class ResetSizeAvailabilityQuantitiesOfNonBmdSellerProductsCommand extends Command
{
    public const scheduledDispatchTime = '04:06';
     ...
     * @var string
     */
    protected $signature = 'ResetSizeAvailabilityQuantitiesOfNonBmdSellerProducts:Execute';
    ...
    public function handle()
    {
        ...
        $resultMsg = 'Automated command execution in CLASS: ResetSizeAvailabilityQuantitiesOfNonBmdSellerProductsCommand.\n';
        $isResultOk = false;
